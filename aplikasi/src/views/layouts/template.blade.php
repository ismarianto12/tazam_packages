...
<head>
    ...
    <link href="{{ pkg_asset('dash', 'css/jquery-confirm.min.css') }}" rel="stylesheet">
...
<body>
        ...
        ">
                    ...
                    <li class="dropdown">
                        ...
                        @else
                            <a href="#" data-toggle="dropdown"
                                ...
                                <img alt="image"
                                    src="{{ pkg_asset('dash', 'dependencies/stisla/img/avatar/avatar-2.png') }}"
                                    class="rounded-circle mr-1">
                                <div class="d-sm-none d-lg-inline-block">Hi, {{ Session::get('username') }}
                                </div>
                            </a>
                ...
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="index.html"> <img
                                src="https://apps.paninbanksyariah.co.id/cms/templates/images/logo_pbs.png" alt=" logo"
                                width="200">
                    </div>
            ...
            <div class="main-content">
                <section class="section">
                    @include('aplikasi::layouts.breadcrumb', ['titledash' => $title])
    ...
    <script src="{{ pkg_asset('dash', 'js/aplikasi.js') }}"></script>
    <script src="{{ pkg_asset('dash', 'js/jquery-confirm.min.js') }}"></script>
