...
use DataTales;
use Bryanjack\Aplikasi\Models\Tmparameter;
use Illuminate\Support\Facades\DB;

class TmparemeterController extends Controller
{
    protected $request;
    protected $route;
    protected $view;
    function __construct(Request $request)
    {
        ...
        $this->view    = 'aplikasi::tmparameter.';
    ...
    {
        return view(
            'aplikasi::tmparameter.index',
            ['title' => 'Parmater Aplikasi']
        );
    }
    ...
    public function create()
    {
        ...
        return view('aplikasi::modulapp.form_add', [
            'title' => 'Tambah Menu',
            'font' => $fonts
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        $fonts = AntonioGabutz::fontawesome();
        return view('aplikasi::modulapp.form_edit', [
            'title' => 'Tambah Menu',
            'id' => $f->id,
