...
class ParameterController extends AbangJeckController
{
    protected $request;
    protected $route;
    protected $view;
    ...
    {
        return view('aplikasi::tmparameter.form_add', [
            'title' => 'Tambah Menu'
        ]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('aplikasi::subtmparameter.form_edit', [
            'title' => 'Tambah Menu',
            'id' => $f->id,
